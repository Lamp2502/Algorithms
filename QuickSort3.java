// quickSort3.java - O(N*logN)
// Быстрая сортировка 2-ая версия улучшения (опорное значение регулируется (Кнут советует 9), при достижении опорного значения выполняется сортировка вставкой)
////////////////////////////////////////////////////////////////
class ArrayIns3
   {
