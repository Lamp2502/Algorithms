...
class AnagramApp
{
    ...
    public static void doAnagram(int newSize)
    {
        ...
        for(int j=0; j<newSize; j++) // Для каждой позиции
        {
            ...
            if(newSize==2) // состояние готово к выводу
    ...
    public static void rotate(int newSize)
    {
        ...
        char temp = arrChar[position]; // Сохранение затираемой буквы
        for(j=position+1; j<size; j++) // Сдвиг остальных букв влево на 1
            arrChar[j-1] = arrChar[j];
        arrChar[j-1] = temp; // Перемещение первой буквы в конец
    } // на правый край
    //-----------------------------------------------------------
